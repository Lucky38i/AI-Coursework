...
def load_conversation(data):
    ...
    for item in data['data']:
        for entry in item['paragraphs']:
            for conversation in entry['qas']:
                inputs.append(preprocess_sentence(conversation['question']))
                for text in conversation['answers']:
                    outputs.append(preprocess_sentence(text['text']))
...
questions, answers = load_conversation(read_data)
